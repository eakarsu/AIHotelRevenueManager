...
// Auto-generated page for: No multi-property fleet management

export default function GapNoMultiPropertyFleetManagement() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-multi-property-fleet-management', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>No multi-property fleet management</h1>
      <p style={{ color: '#666', marginBottom: '1.5rem' }}>No multi-property fleet management</p>
      <form onSubmit={handleSubmit} style={{ marginBottom: '1.5rem' }}>
        ...
        >
          {loading ? 'Processing...' : 'Run No multi-property fleet management'}
        </button>
      </form>

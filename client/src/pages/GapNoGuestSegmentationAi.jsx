...
// Auto-generated page for: No guest segmentation AI

export default function GapNoGuestSegmentationAi() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-guest-segmentation-ai', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>No guest segmentation AI</h1>
      <p style={{ color: '#666', marginBottom: '1.5rem' }}>No guest segmentation AI</p>
      <form onSubmit={handleSubmit} style={{ marginBottom: '1.5rem' }}>
        ...
        >
          {loading ? 'Processing...' : 'Run No guest segmentation AI'}
        </button>
      </form>

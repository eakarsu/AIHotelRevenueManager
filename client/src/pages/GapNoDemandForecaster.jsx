...
// Auto-generated page for: No demand forecaster

export default function GapNoDemandForecaster() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-demand-forecaster', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>No demand forecaster</h1>
      <p style={{ color: '#666', marginBottom: '1.5rem' }}>No demand forecaster</p>
      <form onSubmit={handleSubmit} style={{ marginBottom: '1.5rem' }}>
        ...
        >
          {loading ? 'Processing...' : 'Run No demand forecaster'}
        </button>
      </form>

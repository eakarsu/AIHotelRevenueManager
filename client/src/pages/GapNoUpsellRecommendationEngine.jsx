...
// Auto-generated page for: No upsell recommendation engine

export default function GapNoUpsellRecommendationEngine() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-upsell-recommendation-engine', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>No upsell recommendation engine</h1>
      <p style={{ color: '#666', marginBottom: '1.5rem' }}>No upsell recommendation engine</p>
      <form onSubmit={handleSubmit} style={{ marginBottom: '1.5rem' }}>
        ...
        >
          {loading ? 'Processing...' : 'Run No upsell recommendation engine'}
        </button>
      </form>

...
// Auto-generated page for: No review sentiment analyzer

export default function GapNoReviewSentimentAnalyzer() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-review-sentiment-analyzer', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>No review sentiment analyzer</h1>
      <p style={{ color: '#666', marginBottom: '1.5rem' }}>No review sentiment analyzer</p>
      <form onSubmit={handleSubmit} style={{ marginBottom: '1.5rem' }}>
        ...
        >
          {loading ? 'Processing...' : 'Run No review sentiment analyzer'}
        </button>
      </form>

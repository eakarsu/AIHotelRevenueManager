...
// Auto-generated page for: Occupancy smoothing recommending group events and corporate 

export default function CfOccupancySmoothingRecommendingGroupE() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch('/api/cf-occupancy-smoothing-recommending-group-e', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>Occupancy smoothing recommending group events and corporate </h1>
      <p style={{ color: '#666', marginBottom: '1.5rem' }}>Occupancy smoothing recommending group events and corporate rates to fill gaps.</p>
      <form onSubmit={handleSubmit} style={{ marginBottom: '1.5rem' }}>
        ...
        >
          {loading ? 'Processing...' : 'Run Occupancy smoothing recommending group events and corporate '}
        </button>
      </form>

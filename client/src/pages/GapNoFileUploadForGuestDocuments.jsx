...
// Auto-generated page for: No file upload for guest documents

export default function GapNoFileUploadForGuestDocuments() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-file-upload-for-guest-documents', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>No file upload for guest documents</h1>
      <p style={{ color: '#666', marginBottom: '1.5rem' }}>No file upload for guest documents</p>
      <form onSubmit={handleSubmit} style={{ marginBottom: '1.5rem' }}>
        ...
        >
          {loading ? 'Processing...' : 'Run No file upload for guest documents'}
        </button>
      </form>

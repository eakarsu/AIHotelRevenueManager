...
// Auto-generated page for: No webhook surface for OTA event ingestion

export default function GapNoWebhookSurfaceForOtaEvent() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-webhook-surface-for-ota-event', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>No webhook surface for OTA event ingestion</h1>
      <p style={{ color: '#666', marginBottom: '1.5rem' }}>No webhook surface for OTA event ingestion</p>
      <form onSubmit={handleSubmit} style={{ marginBottom: '1.5rem' }}>
        ...
        >
          {loading ? 'Processing...' : 'Run No webhook surface for OTA event ingestion'}
        </button>
      </form>

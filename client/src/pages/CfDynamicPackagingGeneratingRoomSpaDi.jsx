...
// Auto-generated page for: Dynamic packaging generating room + spa + dining bundles in 

export default function CfDynamicPackagingGeneratingRoomSpaDi() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch('/api/cf-dynamic-packaging-generating-room-spa-di', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>Dynamic packaging generating room + spa + dining bundles in </h1>
      <p style={{ color: '#666', marginBottom: '1.5rem' }}>Dynamic packaging generating room + spa + dining bundles in real-time.</p>
      <form onSubmit={handleSubmit} style={{ marginBottom: '1.5rem' }}>
        ...
        >
          {loading ? 'Processing...' : 'Run Dynamic packaging generating room + spa + dining bundles in '}
        </button>
      </form>

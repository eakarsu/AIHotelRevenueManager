...
// Auto-generated page for: No loyalty program management

export default function GapNoLoyaltyProgramManagement() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-loyalty-program-management', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>No loyalty program management</h1>
      <p style={{ color: '#666', marginBottom: '1.5rem' }}>No loyalty program management</p>
      <form onSubmit={handleSubmit} style={{ marginBottom: '1.5rem' }}>
        ...
        >
          {loading ? 'Processing...' : 'Run No loyalty program management'}
        </button>
      </form>

...
// Auto-generated page for: Reputation + review response monitoring OTA feedback and dra

export default function CfReputationReviewResponseMonitoringOt() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch('/api/cf-reputation-review-response-monitoring-ot', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>Reputation + review response monitoring OTA feedback and dra</h1>
      <p style={{ color: '#666', marginBottom: '1.5rem' }}>Reputation + review response monitoring OTA feedback and drafting management replies.</p>
      <form onSubmit={handleSubmit} style={{ marginBottom: '1.5rem' }}>
        ...
        >
          {loading ? 'Processing...' : 'Run Reputation + review response monitoring OTA feedback and dra'}
        </button>
      </form>

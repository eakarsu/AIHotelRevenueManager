...
// Auto-generated page for: No competitor-rate AI recommender

export default function GapNoCompetitorRateAiRecommender() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-competitor-rate-ai-recommender', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>No competitor-rate AI recommender</h1>
      <p style={{ color: '#666', marginBottom: '1.5rem' }}>No competitor-rate AI recommender</p>
      <form onSubmit={handleSubmit} style={{ marginBottom: '1.5rem' }}>
        ...
        >
          {loading ? 'Processing...' : 'Run No competitor-rate AI recommender'}
        </button>
      </form>
